...
const handleSearch = (val) => {
  ...
  if (val.length > 1) {
    // This calls your utility file logic
    const found = queryAtlas(val, ATLAS_DATA); 
    setSearchResults(found);
    setView("search"); // This line tells React to show the search results page
  } else {
    // If you delete the search text, it goes back to where you were
