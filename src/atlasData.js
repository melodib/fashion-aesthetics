...
export const futuristTechnologicalPhylum = {
  ...
  emoji: "⚛️",
  description: "The 'Source Code' of reality; fashion derived from pure mathematics, physics, and the foundational laws of the universe.",
  order: 0,
  subfamilies: [
    {
      name: "Mathematical-Proof & Logic",
      species: ["Pure-Math Aesthetic", "Mathematical-Proof Couture", "Algorithm-Origin Wear", "Fractal-Base Minimal", "Geometric-Certainty Chic"]
    },
    {
      name: "High-Energy Physics",
      species: ["Pure-Physics Aesthetic", "String-Theory Draping", "Particle-Accelerator Glow", "Quantum-State Mesh", "Entropy-Gradient Silhouette"]
    }
  ]
},
      ...
      subfamilies: [
        {
          ...
          species: ["Biopunk", "Bio-Luminescent Textiles", "Smart Fabric Aesthetic", "Self-Healing Materials", "Mycelium Fashion", "Mushroom Leather Aesthetic", "Algae Fashion", "Spider Silk Fashion", "Kombucha Leather Aesthetic", "Living Material Aesthetic", "Bioprinted Textile Aesthetic", "Mycelium-Bloom Wear", "Mussel-Adhesive Couture"]
        },
        {
        ...
        },
        {
          ...
          species: [
            ...
            "Environmental Bio-Feedback Fashion", "Immortalist Fashion", "Posthuman Eugenics Fashion", "Distributed Body Aesthetic", "Multi-Form Identity Aesthetic", "Neuro-Vascular Lace", "Metabolic-Sync-Wear", "Trans-Species-Drape"
          ]
        },
{
  ...
  species: [
    "Microbiome-Positive Garments/Living Skin-Flora", "pH-Reactive Drip/Enzymatic-Lace", "Enzymatic-Catalysis Mesh","Bacterial-Filter Veils", "Skin-Flora Enhancers", 
...
},
{
      ...
      concept: "The final transition: where the idea of 'clothing' is obsolete and replaced by programmed biological expression.",
      species: [
        "Dermal-Display-Skin", "Structural-Modification-Chic", "Programmable-Pore-Aesthetic", 
        "The-Naked-Machine", "Epidermal-Hardware-Integration", "Metabolic-Aura", 
        "Sub-Dermal-Luminescence", "Post-Human-Eugenics-Fashion"
      ]
    },
        {
          name: "Pathological & Horror Bio",
          species: ["Biohorror Aesthetic", "Infected Organism Fashion", "Parasitic Design Aesthetic", "Mutationcore", "Viral Growth Aesthetic", "Necrotic-Tech", "Parasitic-Design-Luxe", "Apoptotic-Chic" ]
        }
      ]
    },
    // 12 — NEUROTECH
...
{
  name: "AFFECTIVE SYMBIOSIS & INTERSUBJECTIVITY",
  concept: "Technology as a medium for shared emotion, collective memory, and interpersonal bonding.",
  species: [
    "Haptic-Empathy Wear", "Shared-Memory Textiles", "Luminescence-Bonding", "Social-Node Fashion",
    "Neural-Sync Silhouettes", "Consensus-Glow Fashion", "Interpersonal-Network Mesh",
    "Affective-AI Couture", "Digital-Blush Aesthetic", "Oxytocin-Pulse Wear"
  ]
},
        {
    ...
    // 14 — SIMULATION & REALITY
    {
      ...
      subfamilies: [
        ...
        // DIGITAL GHOSTING & PRIVACY (Family 14 Expansion)
{
  ...
  species: [
    ...
    "Digital Ghost-Work Stealthwear", "Unindexed-Persona Aesthetic", "The Un-Simulated Aesthetic"
  ]
},
        {
          name: "Digital Society, Collapse & Instability",
          species: ["Platform Society Aesthetic", "Voxel-Void Minimalism/Lossy-Compression Silk", "Dead-Internet Gothic", "Virtual Class System Aesthetic", "Avatar Status Hierarchy", "Digital Citizenship Fashion", "Metaverse Governance Aesthetic", "Uncanny Valley Aesthetic", "Black Mirror Aesthetic", "Westworld Aesthetic", "Link Rot Aesthetic", "Data Corruption Fashion", "Dead Website Aesthetic", "404 Fashion", "Archive.org Aesthetic", "Beta Perpetual Fashion", "Simulation Fatigue Aesthetic", "Dead Internet Aesthetic", "Platform Collapse Aesthetic", "Algorithmic Decay Aesthetic", "Bot Farm Aesthetic", "Feed Exhaustion Aesthetic", "Content Saturation Aesthetic", "Scroll Fatigue Aesthetic", "Desynced Reality Aesthetic", "Glitch-as-Reality Aesthetic", "Post-Internet Pastoral", "Bureaucratic Futurism"]
        }
      ]
    },
        ...
        },
{
  ...
  species: [
    "Zero-G Tactical", "Tensegrity-Tailoring/Non-Collapsible Volumetrics", "Prehensile-Footwear", "Velocity-Control Suits", 
...
// 19 — TIME & DIMENSIONAL AESTHETICS
{
  ...
  concept: "Speculative fashion for non-linear time, multi-dimensional space, and quantum uncertainty",
  order: 19,
  subfamilies: [
    {
    ...
    },
    {
      ...
      species: ["Superposition-Silk", "Refractive-Warp Mesh/Event-Horizon Sheer", "Schrödinger-Shimmer", "Entanglement-Twinned Set", "Probability-Cloud Mesh", "Quantum Entanglement Wear"]
    },
    {
  ...
  // This is the new logic we just implemented:
  metadata: {
    metabolic: "intrasomatic", // Neural-sync for navigation
    durational: "eternal",      // Time dilation / The "Long-Now"
    visibility: "encrypted"     // Only visible via gravitational sensors
  }
}
  ]
},
// 20 — THE ARCHITECT HIERARCHY (The Establishment)
{
  number: 20,
  name: "THE ARCHITECT HIERARCHY",
  emoji: "🏛️",
  description: 
    "The aesthetics of absolute order, systemic sovereignty, and the 'High-Control' elite who design and regulate reality.",
  order: 20,
  subfamilies: [
    {
      name: "Sovereign Minimalism (The God-Mode)",
      concept: "Aesthetics of the 'Perfect Render'; featureless, zero-seam, and mathematically ideal forms.",
      species: [
        "The Perfect Render Aesthetic", "Architect-Core", "The Untextured Silhouette", "Demiurge-Minimalism", "The Unrendered-White Suit", "Monolithic-Shell", 
        "Vacuum-Sealed Luxe", "Zero-Seam Architecture", "Matte-Ceramic Silhouette", "Zero-Grain Minimalism"
      ]
    },
    {
      name: "Bureaucratic-Sacral & High Law",
      concept: "The intersection of ancient institutional power and algorithmic authority.",
      species: [
        "Algorithmic-Judge-Core", "Algorithmic Sovereign","Regulator-Luxe","Space-Vatican Vestments", "Protocol-Luxe", 
        "Data-Canonization Uniforms", "Algorithmic-High-Baroque", "Regulator-Armor", "Sacred-Data Vestments", "High-Court Neural-Veils", "Legislative-Brocade"
      ]
    },
    {
      name: "High-Baroque Computation",
      concept: "Hyper-complex, 3D-printed patterns following recursive mathematical proofs.",
      species: [
        "Fractal-Authority Couture", "Golden-Ratio Tailoring", "Recursive-Lace", 
        "Calculus-Chic", "Tessellated-Aristocracy", "Procedural-Gilding"
      ]
    },
    {
      name: "Stability, Symmetry & The Void",
      concept: "The aesthetic of the invisible observer; clothing as a sensory node of power.",
      species: [
        "Panopticon-Chic", "Symmetry-Maximalism", "Void-Space Minimalism", "Omniscience-Veil", "Sensor-Integrated Formalwear", "Analog-Luxe",
        "The Transparent-Authority Look", "Metadata-Mastery Tailoring", "LIDAR-Absorbent Formal", "Static-State Fashion", "Equilibrium-Core", "The Un-Simulated Aesthetic"
      ]
    },
    {
      name: "Gravitic & Levitation-Luxe",
      concept: "Mastery over physics as a status symbol; garments that defy traditional weight and drape.",
      species: [
        "Floating-Geometry Accessories", "Magnetic-Levitation Collars", "Tensegrity-Capes", 
        "Zero-G-Gala Wear", "Hover-Drape", "Atmospheric-Anchor Jewelry"
      ]
    }
  ]
},

// PHYLUM X — NON-ANTHROPOMORPHIC & XENOMORPHIC (The Other)
{
  number: 21,
  name: "XENOMORPHIC & NON-HUMAN SYSTEMS",
  emoji: "🧬",
  description: "Aesthetics designed for non-human cognitive partners, robotic swarms, and augmented flora/fauna.",
  order: 21,
  subfamilies: [
    {
      name: "Infrastructure-as-Body",
      concept: "Fashion for high-performance hardware and server environments.",
      species: [
        "Server-Rack Shrouds", "Data-Center Cooling-Skins", "Fiber-Optic Weaving", "Liquid-Cooling Drip",
        "Hardware-Protection Mesh", "Non-Euclidean Renders", "Motherboard-Patterned Shields", "Physics-Defying Light-Skins"
      ]
    },
    {
      name: "Interspecies & Augmented Life",
      concept: "Wearables for non-human biological partners (uplifted animals and sentient plants).",
      species: [
        "Augmented-Flemish-Giant Harness", "Augmented-Fauna Harness", "Cognitive-Partner Vests", "Sentient-Flora Support-Frames", 
        "Neural-Link Animal-Vests", "Bionic-Fauna Armor", "Root-System Connectivity-Wear"
      ]
    },
    {
      name: "Swarm & Collective Identity",
      concept: "Aesthetics for decentralized robotic swarms and drone-cluster 'clothing'.",
      species: [
        "Swarm-Cohesion Veils", "Drone-Cluster Silhouette", "Synchronized-Light-Hives", 
        "Distributed-Identity Mesh", "Autonomous-Agent Camouflage"
      ]
    }
  ]
},
{
  ...
  emoji: "🏔️",
  description: "Technological systems optimized for deep-wilderness, off-grid frontiers, and planetary exploration without urban infrastructure.",
  order: 22,
  subfamilies: [
    {
      name: "Atmospheric & Solar Harvesting",
      species: ["Atmospheric-Water-Harvesting Cloak", "Atmospheric-Harvesting Cloak", "Solar-Albedo Maximalism", "Wind-Kinetic Techwear", "Mist-Trap Veils"]
    },
    {
      name: "High-Wilderness Survival",
      species: ["Deep-Forest Signal-Scavenger", "Neo-Nomadic Thermal-Mesh", "Mountain-Peak Minimalist", "Glacier-Shield Tech"]
    },
    {
      name: "Planetary Frontier",
      species: ["Exoplanet-Scout Uniform", "Terraformer-Base Layer", "Crater-Dust Resistant Gear", "First-Contact Formal"]
    }
  ]
},
{
  ...
  emoji: "🥂",
  description: "Aesthetics of the hyper-wealthy or post-labor society where fashion is purely conceptual, hedonic, or symbolic.",
  order: 23,
  subfamilies: [
    {
      name: "Hedonic & Affective Luxury",
      species: ["Dopamine-Drip Couture", "Hedonic-Glow Wear","Emotion-Broadcast Silk", "Sensory-Satiation Robes", "Euphoria-Glow Minimal"]
    },
    {
      name: "Conceptual Existence",
      species: ["Post-Scarcity Tourist", "Conceptual-Existence Drapery", "Eternal-Vacation Minimalism", "Object-Lesson Fashion", "Symbolic-Capital Drapery"]
    },
    {
      name: "The 'Naked' Machine (Post-Textile)",
      concept: "When the body itself is the only garment needed.",
      species: ["Dermal-Display Skin", "Structural-Modification Chic", "Programmable-Pore Aesthetic", "The Naked-Machine"]
    }
  ]
},
