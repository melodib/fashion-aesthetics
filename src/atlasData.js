export const ATLAS_DATA = {
  ...
  phyla: [
    ...
    },
    {
      ...
      emoji: "🚀",
      description:
        "Speculative science, human-machine futures, and the aesthetics of tomorrow",
      classes: [
        {
          name: "STEAMPUNK & RETRO-FUTURISM",
          species: [
            ["Stonepunk", "N"],
            ["Cassettepunk", "N"],
            ["Sandalpunk", "N"],
            ["Clockpunk", "N"],
            ["Steampunk", "N"],
            ["Victoriana Tech Aesthetic", "N"],
            ["Brass & Gears Aesthetic", "N"],
            ["Airship Aesthetic", "N"],
            ["Clockwork Aesthetic", "N"],
            ["Inventor Aesthetic", "N"],
            ["Gaslamp Fantasy", "X"],
            ["Decopunk", "N"],
            ["Dieselpunk", "N"],
            ["Atompunk", "N"],
            ...
            ["Raygun Gothic", "N"],
            ["Cassette Futurism", "N"],
            ["Neo-Victorian AI / Automaton Aesthetic", "N"],
            ["Industrial Laboratory Fashion", "N"],
            ["Airship Crew / Navigator Uniforms", "N"],
            ["Retro-Scientific Explorer", "N"],
            ["Mythpunk", "N"],
            ["Arcanepunk", "N"],
            ["Elfpunk", "N"],
            ["Nowpunk", "N"],
            ["Solarpunk Victorian", "N"],
            ["Silkpunk", "N"],
            ["Rococopunk", "N"],
            ["Fiberpunk", "N"],
            ["Transistorpunk", "N"],
        ...
        {
          name: "VAPORWAVE & DIGITAL NOSTALGIA",
          species: [
            ["Vaporwave", "X"],
            ["Synthwave", "N"],
            ["Retrowave", "N"],
            ...
            ["Dreamwave Aesthetic", "N"],
            ["Lo-Fi Future Aesthetic", "N"],
            ["Pastel Vaporwave", "N"],
            ["Dark Vaporwave", "N"],
            ["Vaporgoth", "N"],
            ["Vaporwave Street", "N"],
            ["Corporate Memphis Aesthetic", "N"],
            ["Y2K Futurism", "N"],
            ["Broken Transmission Aesthetic", "N"],
            ["Aesthetic Glitch", "N"],
            ["Hauntology Aesthetic", "N"],
            ["Utopian Superflat", "N"],
            ["Neo-Vaporwave", "N"],
            ["AI-Generated Retro Aesthetic", "N"],
            ["Cyber-Memphis Hybrid", "N"],
            ["3D Mallsoft / Virtual Arcade Fashion", "N"],
            ["Pixel Nostalgia", "N"],
            ["Technozen", "N"],
            ["Signalwave", "N"],
            ["Simpsonwave", "N"],
            ...
            ["Weirdcore", "X"],
            ["Analog Horror Aesthetic", "X"],
            ["Signalwave Aesthetic", "N"],
          ],
        },
        {
          name: "CYBERPREP & TECH OPTIMISM",
          species: [
            ["Cyberprep", "N"],
            ["Digital Nomad Tech Aesthetic", "N"],
            ["Data Center Aesthetic", "N"],
            ["Tech Utopia Aesthetic", "N"],
            ["Clean Tech Aesthetic", "N"],
            ["Minimalist Tech Aesthetic", "N"],
            ["Apple Aesthetic", "X"],
            ["Interface Aesthetic", "N"],
            ["Operating System Aesthetic", "N"],
            ["Beta Version Aesthetic", "N"],
            ["Innovation Aesthetic", "N"],
            ["Future Perfect Aesthetic", "N"],
            ["Holographic UI Aesthetic", "N"],
            ["Silicon Valley Aesthetic", "X"],
            ["Silicon Valley Uniform", "N"],
            ["Big Tech Campus Aesthetic", "N"],
            ["Web3 / Crypto Aesthetic", "N"],
            ["Terminal Aesthetic", "N"],
            ["Monospace Typography Wear", "N"],
            ["ASCII Print Aesthetic", "N"],
            ["Wireframe Silhouette", "N"],
            ["Green Code Aesthetic", "X"],
            ["Grid System Aesthetic", "N"],
            ["Data Visualization Aesthetic", "N"],
            ["Transparent Tech Aesthetic", "N"],
            ["Keynote Aesthetic", "N"],
            ["Hackathon Aesthetic", "N"],
            ["Silicon Zen", "N"],
            ["Technozen Fashion", "N"],
            ["Effective Altruist Aesthetic", "N"],
            ["Longtermist Aesthetic", "N"],
            ["Abundance Aesthetic", "N"],
            ["Recoverycore", "N"],
            ["Digital Detox Aesthetic", "X"],
            ["Dumbphone Aesthetic", "N"],
            ["Slow Tech Aesthetic", "N"],
          ],
        },
        {
          name: "TECHWEAR & FUNCTIONAL FUTURE",
          species: [
            ["Techwear", "N"],
            ["Acronym Aesthetic", "N"],
            ["Urban Tactical Aesthetic", "N"],
            ["Tactical Streetwear", "N"],
            ["Gorpcore Luxe", "X"],
            ["Technical Fabric Aesthetic", "N"],
            ["Modular Clothing Aesthetic", "N"],
            ["Utility Vest Aesthetic", "N"],
            ["Cargo Future Aesthetic", "N"],
            ["Stealth Techwear", "N"],
            ["Ninja Techwear", "N"],
            ["Techwear Minimal", "N"],
            ["Techwear Maximalist", "N"],
            ["Military Utility Fashion", "X"],
            ["Tactical Civilian Aesthetic", "N"],
            ["Functional Dystopia Aesthetic", "N"],
            ["Exosuit-Inspired Fashion", "N"],
            ["Adaptive Weatherwear", "N"],
            ["Urban Recon Aesthetic", "N"],
            ["Cybersecurity Agent Aesthetic", "N"],
            ["Workwear Future", "N"],
            ["Biometric-Luxe", "N"],
            ["Thermoregulation-Core", "N"],
            ["Augmented / Smart Layering", "N"],
            ["Extreme Climate Techwear", "N"],
            ["Urban Mobility Techwear", "N"],
            ["Disaster Response Techwear", "N"],
            ["Cybergrunge", "N"],
            ["Medical Techwear", "N"],
            ["Climate Emergency Wear", "N"],
            ["Soft Techwear", "N"],
          ],
        },
        {
          ...
          species: [
            ...
            ["Smart City Aesthetic", "N"],
            ["Blade Runner Aesthetic", "N"],
            ["Akira Aesthetic", "N"],
            ["Ghost in the Shell Aesthetic", "N"],
            ["Cyberpunk Anime Aesthetic", "N"],
            ["Shadowrun Aesthetic", "N"],
            ["Classic Cyberpunk Aesthetic", "N"],
            ["Cyberpunk", "N"],
            ["Neon Cyberpunk", "N"],
            ["Neon Noir Aesthetic", "N"],
            ["Low Life High Tech Aesthetic", "N"],
            ["Chrome Aesthetic", "N"],
            ["Corporate Dystopia Aesthetic", "N"],
            ["Augmented Human Aesthetic", "N"],
            ["Neural Interface Aesthetic", "N"],
            ["Holographic Streetwear", "N"],
            ["LED Fashion", "N"],
            ["Augmented Reality Outfit", "N"],
            ["VR-Inspired Aesthetic", "N"],
            ["Cyberpunk 2077 Aesthetic", "N"],
            ["Post-Cyberpunk / Soft Cyberpunk", "N"],
            ["Bio-Neon Hybrid Aesthetic", "N"],
            ["Corporate Espionage Aesthetic", "N"],
            ["Digital Street Hacker Aesthetic", "N"],
            ["Corporate Gothic", "N"],
            ["High Fashion Cyberpunk", "N"],
            ["Domestic Cyberpunk", "N"],
            ["Pastoral Cyberpunk", "N"],
          ],
        },
        {
          name: "CYBER GOTH & DARK TECH",
          species: [
            ["Cyber Goth", "X"],
            ["Drone Culture Aesthetic", "N"],
            ["Industrial Goth", "X"],
            ["Health Goth", "X"],
            ["Neon Goth", "X"],
            ["EBM Fashion", "X"],
            ["Dark Electro Fashion", "X"],
            ["Dark Cyber Aesthetic", "N"],
            ["Machine Aesthetic", "N"],
            ["Dystopian Club Aesthetic", "N"],
            ["Control Aesthetic", "N"],
            ["Panopticon Aesthetic", "N"],
            ["Surveillance Aesthetic", "N"],
            ["Dark Web Aesthetic", "N"],
            ["Industrial Decay / Ruin Goth", "N"],
            ["Hacktivist Aesthetic", "N"],
            ["Bio-Industrial Goth", "N"],
            ["Neon Noir / Cyberpunk Club", "N"],
            ["Synthwave Goth", "N"],
            ["Digital Occult / Cryptographic Goth", "N"],
            ["Terminal Noir Aesthetic", "N"],
            ["Corpcore", "N"],
            ["Dark Rave Aesthetic", "N"],
            ["Doomscroll Aesthetic", "N"],
            ["Necrotic Tech", "N"],
            ["Witch House Aesthetic", "X"],
            ["Dronecore", "N"],
            ["CV Dazzle Aesthetic", "N"],
        ...
        },
        {
          ...
          species: [
            ["Post-Apocalyptic Aesthetic", "N"],
            ["Dystopian Fashion", "N"],
            ["Survivalist Chic", "X"],
            ["Mad Maxcore", "N"],
            ["Road Warrior Aesthetic", "N"],
            ["Wasteland Aesthetic", "N"],
            ["Scavenger Aesthetic", "N"],
            ["Bunker Aesthetic", "N"],
            ["Biohazard Chic", "N"],
            ["Nuclear Winter Aesthetic", "N"],
            ["Climate Apocalypse Aesthetic", "N"],
            ["Reclaimed Fabric Aesthetic", "X"],
            ["Rust Belt Aesthetic", "N"],
            ["Collapsed Infrastructure Aesthetic", "N"],
            ["Dustbowl Dystopia", "N"],
            ["Emergency Fashion", "N"],
            ["Fallout Aesthetic", "X"],
            ["The Last of Us Aesthetic", "X"],
            ["Nomadic Survivor Aesthetic", "N"],
            ["Desert Punk / Dust Nomad Aesthetic", "N"],
            ["Armored Street Survivor Aesthetic", "N"],
            ["Radiation Survivor Aesthetic", "N"],
            ["Chemical Fallout Fashion", "N"],
            ["Flooded / Waterworld Survival Aesthetic", "N"],
            ["Salvaged Tech Wear", "N"],
            ["Patchwork / Repurposed Material Aesthetic", "N"],
            ["Urban Ruin Aesthetic", "N"],
            ["Zombie Apocalypse Aesthetic", "N"],
            ["Cinematic Wasteland Aesthetic", "N"],
            ["Prepper Compound Aesthetic", "N"],
            ["Doomsday Cult Fashion", "S"],
            ["Social Credit Fashion", "S"],
            ["Authoritarian Uniform Aesthetic", "S"],
            ["Cli-Fi Survival Aesthetic", "N"],
            ["Waterworld Fashion", "N"],
            ["Mutual Aid Fashion", "N"],
          ],
        },
        {
          name: "SOLARPUNK & ECO-FUTURES",
          species: [
            ["Greenpunk", "N"],
            ["Climate Engineering Aesthetic", "N"],
            ["Eco-Tech Aesthetic", "N"],
            ["Renewable Energy Aesthetic", "N"],
            ["Rewilded City Aesthetic", "N"],
            ["Green Architecture Aesthetic", "N"],
            ["Sustainable Future Fashion", "N"],
            ["Living Material Aesthetic", "N"],
            ["Biomimicry Aesthetic", "N"],
            ["Community Tech Aesthetic", "N"],
            ["Cooperative Future Aesthetic", "N"],
            ["Degrowth Aesthetic", "N"],
            ["Cli-Fi Aesthetic", "N"],
            ["Indigenous Futurism", "S"],
            ["Hopepunk Fashion", "N"],
            ["Regenerative Urbanist", "N"],
            ["Solar Fabric Aesthetic", "N"],
            ["Eco-Interactive Wearables", "N"],
            ["Circular Fashion Aesthetic", "N"],
            ["Water-Conscious Fashion", "N"],
            ["Hydrofuturism", "N"],
            ["Kelp Textile Aesthetic", "N"],
            ["Seasteading Fashion", "N"],
            ["Permaculture Fashion", "N"],
            ["Land Back Aesthetic", "S"],
            ["Technozen Eco", "N"],
            ["Lunarpunk", "N"],
            ["Oceanpunk", "N"],
            ["Tidalpunk", "N"],
        ...
        {
          name: "BIOFABRICATION & LIVING MATERIALS",
          species: [
            ["Biopunk", "N"],
            ["Biometric Clothing", "N"],
            ["Genetic Pattern Garments", "N"],
            ["Bio-Luminescent Textiles", "N"],
            ["Smart Fabric Aesthetic", "N"],
            ["Self-Healing Materials", "N"],
            ["Biomimicry Couture", "N"],
            ["Mycelium Fashion", "N"],
            ["Mushroom Leather Aesthetic", "N"],
            ["Algae Fashion", "N"],
            ["CRISPR Fashion", "N"],
            ["Coral Labcore Aesthetic", "N"],
            ["Insect-Inspired Wear", "N"],
            ["DNA Pattern Wardrobe", "N"],
            ["Synthetic Skin Clothing", "N"],
            ["Lab Coat Couture", "N"],
            ["Genetic Expression Fashion", "N"],
            ["Wetware Aesthetic", "N"],
            ["Sustainable Futurism", "X"],
            ["Bio-Tech Symbiotic Aesthetic", "N"],
            ["Algae-Drip Aesthetic", "N"],
            ["Mycelium-Tech Aesthetic", "N"],
            ["Synthetic Microbe Fashion", "N"],
            ["Programmable Genetic Textiles", "N"],
            ["Neural-Responsive Bio-Fabric", "N"],
            ["Eco-Bio Fashion", "N"],
            ["Kombucha Leather Aesthetic", "N"],
            ["Spider Silk Fashion", "N"],
            ["Ocean Textile Aesthetic", "N"],
            ["Fermentation Fashion", "N"],
            ["Bioprinted Textile Aesthetic", "N"],
            ["Living Colour Fashion", "N"],
            ["Mussel Adhesive Fashion", "N"],
            ["Fungal Network Fashion", "N"],
            ["Terroir Fashion", "N"],
            ["Phenotype Fashion", "N"],
          ],
        },
        {
          ...
          species: [
            ["Biohacker Aesthetic", "N"],
            ["Grinder Aesthetic", "N"],
            ["DIY Implant Fashion", "N"],
            ["Genetic Fashion", "N"],
            ["Quantified Self Aesthetic", "N"],
            ["Epigenetic Chic", "N"],
            ["Body Modification Aesthetic", "N"],
            ["Transhumanist Aesthetic", "N"],
            ["Cyborg Elegance", "N"],
            ...
            ["Synthetic Organ Fashion", "S"],
            ["Biohacker Uniforms", "N"],
            ["Hacker-Maker Fusion", "N"],
            ["CRISPR Couture", "N"],
            ["Extreme Biohacking", "N"],
            ["Environmental Bio-Feedback Fashion", "N"],
            ["Longevity Aesthetic", "N"],
            ["Cryonics Aesthetic", "N"],
            ["Accelerationist Body Aesthetic", "S"],
            ["Posthuman Eugenics Fashion", "S"],
            ["Optimized Human Aesthetic", "N"],
        ...
        },
        {
          ...
          species: [
            ...
            ["Neural Mod Aesthetic", "N"],
            ["Augmented Sense Aesthetic", "N"],
            ["Neural-Link Aesthetic", "N"],
            ["Neuro-Affective Fashion", "N"],
            ["Memory Augmentation Fashion", "N"],
            ["Cognitive Interface Aesthetic", "N"],
            ["Emotion-Sensing Fashion", "N"],
            ["Neuro-Responsive Fashion", "N"],
            ["BCI Fashion Aesthetic", "N"],
            ["Screen Dress Aesthetic", "N"],
            ["EEG Headwear Aesthetic", "N"],
            ["Neural Feedback Fashion", "N"],
            ["Brainwave-Driven Fashion", "N"],
            ["Neural Earbud Aesthetic", "N"],
            ["Mind-State Fashion", "N"],
            ["Consciousness Couture", "N"],
            ["Dreamscape Couture", "N"],
            ["Cognitive Enhancement Aesthetic", "N"],
            ["Meditation Tech Aesthetic", "N"],
            ["Synesthesia Fashion", "N"],
            ["Neural Privacy Aesthetic", "N"],
            ["Silent Speech Fashion", "N"],
            ["Neural Sovereignty Aesthetic", "N"],
            ["Empathy Interface Aesthetic", "N"],
            ["Neuroethics Fashion", "N"],
            ["Collective Mind Aesthetic", "N"],
            ["Sleep Architecture Fashion", "N"],
            ["Psychedelic Interface Fashion", "N"],
            ["Neuro-Surveillance Fashion", "S"],
          ],
        },
        {
          ...
          species: [
            ...
            ["Gravitypunk", "N"],
            ["Cosmonaut Aesthetic", "N"],
            ["Space Race Aesthetic", "N"],
            ["NASA Aesthetic", "N"],
            ["Astronaut Aesthetic", "N"],
            ["Space Station Aesthetic", "N"],
            ["Cosmic Futurism", "N"],
            ["Spacecore", "X"],
            ["Interstellar Aesthetic", "N"],
            ["Terraforming Aesthetic", "N"],
            ["Colony Aesthetic", "N"],
            ["Zero Gravity Fashion", "N"],
            ["Martian Colonist Wardrobe", "N"],
            ["Extraterrestrial Minimalism", "N"],
            ["Dyson Sphere Aesthetic", "N"],
            ["SpaceX Aesthetic", "N"],
            ["Afrofuturism", "X"],
            ["Space Opera Fashion", "X"],
            ["Solarpunk", "X"],
            ["Lunarpunk", "X"],
            ["Star Trek Aesthetic", "X"],
            ["Star Wars Aesthetic", "X"],
            ["Dune Aesthetic", "X"],
            ["Black Panther / Wakanda Tech Aesthetic", "N"],
            ["Deep Space Aesthetic", "N"],
            ["James Webb Aesthetic", "N"],
            ["Retro-Futurist Space Aesthetic", "N"],
            ["Orbital Designer Fashion", "N"],
            ["Intergalactic Diplomat Aesthetic", "N"],
            ["Asteroid Miner Aesthetic", "N"],
            ["Exoplanet Settler Aesthetic", "N"],
            ["Quantum Fashion", "N"],
            ["First Contact Aesthetic", "N"],
            ["Void Drift Aesthetic", "N"],
            ["Solar Civilization Aesthetic", "N"],
            ["Space Mining Fashion", "N"],
            ["Cosmic Horror Fashion", "X"],
            ["Sinofuturism", "N"],
            ["Gulf Futurism", "N"],
            ["South Asian Futurism", "N"],
            ["Latinofuturismo", "N"],
            ["Indigenous Futurism", "S"],
            ["Afro-Caribbean Futurism", "X"],
            ["Mediterranean Futurism", "N"],
            ["Pan-African Futurism", "X"],
          ],
        },
        {
          name: "AI & POSTHUMAN",
          species: [
            ...
            ["Nanopunk", "N"],
            ["AI Chic", "N"],
            ["Drone Swarm Aesthetic", "N"],
            ["Androidcore", "N"],
            ["Robot Aesthetic", "N"],
            ["Humanoid Aesthetic", "N"],
            ["Posthuman Aesthetic", "N"],
            ["Singularity Aesthetic", "N"],
            ["Digital Human Aesthetic", "N"],
            ["Computational Aesthetic", "N"],
            ["Deepfake Aesthetic", "N"],
            ["Glitch Identity Aesthetic", "N"],
            ["Error Aesthetic", "N"],
            ["404 Aesthetic", "N"],
            ["Nano-Tech Couture", "N"],
            ["Shape-Shifting Outfits", "N"],
            ["Generative AI Aesthetic", "N"],
            ["AI Art Aesthetic", "N"],
            ["Prompt Engineering Aesthetic", "N"],
            ["Latent Space Aesthetic", "N"],
            ["Prompt-Core", "N"],
            ["Procedural Textile Aesthetic", "N"],
            ["Sentient AI Aesthetic", "N"],
            ["Cognitive Couture", "N"],
            ["Cyborgcore", "N"],
            ["Bio-Digital Aesthetic", "N"],
            ["Swarm-Tech Fashion", "N"],
            ["Morphogenic Couture", "N"],
            ["Augmented AI Persona", "N"],
            ["Dead Internet Aesthetic", "N"],
            ["AI Ethics Fashion", "N"],
            ["Alignment Aesthetic", "N"],
            ["Post-Singularity Fashion", "N"],
            ["Hive Mind Fashion", "N"],
            ["Ghost in the Network", "X"],
            ["AI Doomer Aesthetic", "N"],
            ["Paperclip Maximizer Aesthetic", "N"],
            ["Longtermist Fashion", "X"],
          ],
        },
        {
          ...
          species: [
            ["Matrixcore", "N"],
            ["Algorithmic Governance Aesthetic", "N"],
            ["Memory Economy Aesthetic", "N"],
            ["Simulation Aesthetic", "N"],
            ["Coded Reality Aesthetic", "N"],
            ["Red Pill / Blue Pill Aesthetic", "N"],
            ["Green Code Aesthetic", "N"],
            ["Glitch Reality Aesthetic", "N"],
            ["Parallel Universe Aesthetic", "N"],
            ["Multiverse Aesthetic", "X"],
            ["Digital Existentialism Aesthetic", "N"],
            ["Avatar Reality Aesthetic", "N"],
            ["Rendered Aesthetic", "N"],
            ["Uncanny Valley Aesthetic", "N"],
            ...
            ["404 Fashion", "N"],
            ["Archive.org Aesthetic", "N"],
            ["Beta Perpetual Fashion", "N"],
        ...
        },
        {
          ...
          species: [
            ...
            ["Soft Futurism", "N"],
            ["Hard Futurism", "N"],
            ["Fluid Future Aesthetic", "N"],
            ["Genderless Future Aesthetic", "N"],
            ["Bio-Fashion Aesthetic", "N"],
            ["Printed Fashion Aesthetic", "N"],
            ["Smart Textile Aesthetic", "N"],
            ["Wearable Tech Aesthetic", "N"],
            ["Transhumanist Wardrobe", "N"],
            ["Quantum Textile Experiment", "N"],
            ["Anti-Gravity Couture", "N"],
            ["Climate-Adapted Futurewear", "N"],
            ["Virtual Runway Aesthetic", "N"],
            ...
            ["Algorithmic Fashion", "N"],
            ["Generative Pattern Fashion", "N"],
            ["Datawear Aesthetic", "N"],
            ["Avatar Fashion", "N"],
            ["Holographic Fashion", "N"],
            ["Augmented Reality Fashion", "N"],
            ["Space Habitat Fashion", "N"],
            ["Extreme Environment Fashion", "N"],
            ["Micro-Climate Fashion", "N"],
            ["Non-Human Fashion", "N"],
            ["Quantum Entanglement Wear", "N"],
            ["Extinction Aesthetic", "S"],
            ["Post-Carbon Fashion", "N"],
            ["Solarpunk Y3K", "N"],
            ["Mega-Structure Fashion", "N"],
            ["Uploaded Civilization Fashion", "N"],
            ["Geologic Futurism", "N"],
            ["Lithopunk", "N"],
            ["Deep Time Aesthetic", "N"],
            ["Slow Violence Fashion", "N"],
          ],
        },
      ],
      count: 506,
