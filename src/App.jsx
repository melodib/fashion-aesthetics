        ...
        {view==="home" && (
          <div>
            <div style={{textAlign:"center",padding:"2.5rem 0 3rem",borderBottom:`1px solid ${ACCENT}`,marginBottom:"2rem"}}>
              ...
              <p style={{color:INK,fontFamily:"Georgia,serif",fontSize:"0.85rem",maxWidth:"520px",margin:"0 auto 0.75rem",lineHeight:1.8,opacity:0.75}}>
                Organised by origin engine, not visual appearance. Click any species to open its field guide entry — colour palette, visual description, key garments, habitat, cultural context, and media touchstones.
              </p>
              <p style={{color:ACCENT,fontFamily:"Georgia,serif",fontSize:"0.88rem",maxWidth:"440px",margin:"0 auto",lineHeight:1.7,fontStyle:"italic"}}>
